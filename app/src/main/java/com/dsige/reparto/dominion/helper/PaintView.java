...
public class PaintView extends View {
    ...
    public String save(Context context, int id, int tipo, String f) {
        ...
        File folder = Dialog.getFolder(context);
        String nameImg;
        if (f.isEmpty()) {
            nameImg = Dialog.getDateFirmReparto(id, tipo);
        } else {
            nameImg = Dialog.getDateFirmReconexiones(id, tipo, f);
        }
        ...
        Dialog.comprimirImagen(direccion);
        return nameImg;
    }
}